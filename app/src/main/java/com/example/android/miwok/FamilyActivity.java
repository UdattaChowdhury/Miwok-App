...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        num.add(new word("Brother","chalitti",R.drawable.family_younger_brother,R.raw.family_younger_brother));
        num.add(new word("Sister","kolliti",R.drawable.family_younger_sister,R.raw.family_younger_sister));
        num.add(new word("son","angsi",R.drawable.family_son,R.raw.family_son));
        num.add(new word("Husband","taachi",R.drawable.family_older_brother,R.raw.family_older_brother));
        num.add(new word("Wife","teṭe",R.drawable.family_older_sister,R.raw.family_older_sister));
        num.add(new word("Grand father","paapa",R.drawable.family_grandfather,R.raw.family_grandfather));
